    ...
    <div style={{ backgroundColor: "#111010" }}>
      ...
      <section style={{ position: "relative", height: isMobile ? "60vh" : "100vh", minHeight: isMobile ? "400px" : "600px", overflow: "hidden" }}>
        <img
          ...
          style={{ position: "absolute", inset: 0, width: "100%", height: "100%", objectFit: "cover", objectPosition: isMobile ? "47% center" : "center center" }}
        />
        {/* Dark overlay */}
        ...
        {/* Hero content */}
        <div style={{ position: "relative", zIndex: 2, height: "100%", display: "flex", flexDirection: "column", justifyContent: isMobile ? "flex-start" : "center", paddingTop: isMobile ? "6rem" : "0", padding: isMobile ? "6rem 1.25rem 0" : "0 2rem 0 18rem", maxWidth: "1440px", margin: "0 auto" }}>
