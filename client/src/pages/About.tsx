      ...
      <section style={{ padding: "6rem 0 8rem", backgroundColor: "#111010" }}>
        <div style={{ maxWidth: "800px", margin: "0 auto" }} className="page-x">
          ...
          <Reveal>
            ...
            <p style={{ fontFamily: "'Lato', sans-serif", fontSize: "0.95rem", color: "rgba(240,237,232,0.7)", lineHeight: 1.9, marginBottom: "1.5rem", paddingLeft: "1.5rem", borderLeft: "1px solid rgba(240,237,232,0.2)" }}>
